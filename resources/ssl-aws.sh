#!/bin/bash -e
# ./resources/ssl-aws.sh 54.194.244.173 ip-172-31-10-8.eu-west-1.compute.internal,server.dc1.yorc 172.31.10.8,54.194.244.173 /Users/xdegenne/work/src/alien4cloud-artemis-spray/certificates/
...
# Generate a key pair
echo "Generate a key pair for $CN"
